                    ...
                    <div className="flex min-h-[26rem] flex-col rounded-[inherit] pt-16 lg:min-h-[28.9375rem]">
                      ...
                      <div className="mt-auto flex flex-col gap-4 p-6 text-left sm:p-8">
                        ...
                        <p className="body-main text-secondary font-medium">
                          Gaspo is published in the official Slack App Directory. That
              ...
              <div className="flex items-center rounded-2xl bg-white/88 p-4 shadow-[inset_2.702px_2.702px_1.351px_0px_white,inset_-2.702px_-2.702px_1.351px_0px_white,inset_0px_0px_8.106px_0px_rgba(255,255,255,0.5),inset_0px_0px_43.232px_0px_#f2f2f2] backdrop-blur-[12px] sm:min-h-24 sm:px-6">
                <div className="grid w-full gap-x-5 gap-y-4 md:grid-cols-[minmax(0,1fr)_auto] md:items-center lg:grid-cols-[minmax(0,260px)_minmax(0,180px)_minmax(0,1fr)_minmax(0,340px)] lg:items-center">
                  ...
                  <div className="flex min-w-0 items-center gap-3 md:justify-self-start">
                    ...
                    <span className="inline-flex h-8 shrink-0 items-center justify-center rounded-full border border-black px-5 text-[14px] leading-[1.3] font-medium text-black">{r.badge}</span>
                  </div>
    ...
    <div className="relative pb-8">
      <div
        className={`relative rounded-[28px] h-32 ${
          active ? "bg-black" : "border border-zinc-300 bg-white"
        }`}
      />
      <div className="absolute left-1/2 -translate-x-1/2 -bottom-3 flex flex-col items-center">
        ...
        <span
          className={`mt-2 px-3 py-1 rounded-full text-xs font-semibold ${
            active ? "bg-black text-white" : "border border-zinc-300 text-zinc-600"
          }`}
        >
          {label}
        </span>
...
const riskTabs: {
  ...
  },
  {
    ...
    lead: "Before Gaspo sends an email, pushes code, modifies an ad campaign, or charges a card, it shows you exactly what it wants to do and waits for approval or rejection in Slack.",
  ...
  },
  {
    ...
    lead: "Conversations, files, business data, and outputs stay in your workspace. We do not use customer data to train Gaspo, and our model providers do not either.",
          ...
          >
            <div className="flex flex-col gap-12 md:gap-14 xl:flex-row xl:items-start xl:justify-between xl:gap-[106px]">
              <div className="w-full xl:w-[434px] xl:pt-[42px]">
                <div className="pb-4">
                  <p className="text-sm text-[#fff] font-medium">AI Safety</p>
                </div>
...
const pillars = [
  { icon: PillarAccessIcon, title: "Access you control", body: "Granular scopes, SSO, SAML, and SCIM. Grant exactly what Gaspo needs, revoke in one click, and provision your whole team automatically." },
  { icon: PillarVisibilityIcon, title: "Visibility you can trust", body: "A full audit log of every action, queryable and exportable. Know what Gaspo did, when, and on whose behalf — always." },
            ...
            <p className="text-white/75 text-md leading-relaxed pb-4">Credentials & secrets</p>
              ...
              <div className="mt-8 space-y-5 max-w-md">
                <div className="border-b border-white/15 pb-5">
                  ...
                  <p className="text-white/75 text-md leading-relaxed">Gaspo connects through OAuth wherever possible — no passwords pasted into a message, ever.</p>
                </div>
                <div className="border-b border-white/15 pb-5">
    ...
    <section className="px-6 py-12 sm:pt-26 sm:pb-12">
      <div className="mx-auto max-w-6xl">
        ...
        <p className="mt-8 mx-auto max-w-2xl text-center text-sm text-muted-foreground leading-relaxed font-medium">
          We are building a formal bug bounty program. In the meantime, we recognize meaningful security research with a thank you, public credit if you want it, and Gaspo credits.
        </p>
      </div>
    </section>
  );
