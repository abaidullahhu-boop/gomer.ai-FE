...
export default function ProductPage() {
  return (
    <div className="min-h-screen bg-primitive-main-beige">
      <PageMeta
        title="Product — Zundy, an AI coworker for your entire team"
        description="Zundy is an AI coworker that plugs into your tools, talks in Slack, and ships real deliverables — built for teams, secure by default."
        ogTitle="Product — Zundy"
        ...
        <div className="hero-page-stack-pt relative z-10 mx-auto flex w-full max-w-[1440px] flex-col items-center gap-8 mt-16 px-5 pb-20 text-center sm:px-8 md:px-12 md:pb-24 lg:px-20 lg:pb-28">
          ...
          <div className="flex max-w-5xl flex-col items-center gap-6">
            ...
            <p className="max-w-[34.1875rem] body-medium text-secondary font-medium">
              Zundy doesn&apos;t just answer questions. It does the work: pulling reports, managing
...
/* ---------------- SECTION 2: WHAT ZUNDY IS ---------------- */
const whatZundyIsFeatures = [
  {
    title: "Your AI employee",
    description:
      "Zundy is a managed AI employee that operates across your entire organization. Add it to Slack or Microsoft Teams (soon) — and every person on your team gets access to an AI that can do real, meaningful work across every department.",
    icon: (
      <svg
...
function SectionWhatZundyIs() {
  return (
    <section id="what-zundy-is" className="py-10 sm:py-12 bg-primitive-main-beige">
          ...
          <div className="bg-hero dark mx-auto w-full max-w-[1440px] overflow-hidden rounded-[2.5rem]">
            <div className="flex flex-col gap-10">
              <div className="px-6 sm:px-10 lg:px-16 pt-10 sm:pt-12 lg:pt-16">
                <h2 className="font-heading h3 text-center text-white sm:h2">What Zundy is</h2>
              </div>

              <IntegrationsLogoLoop
                variant="product"
                className="product-what-zundy-is-animation"
              />

              <div className="grid gap-8 px-6 sm:px-10 lg:px-16 pb-10 sm:pb-12 lg:pb-16 md:grid-cols-3 md:gap-6 lg:gap-8">
                {whatZundyIsFeatures.map((feature) => (
...
/* ---------------- SECTION 3: WHAT ZUNDY CAN DO (cards grid) ---------------- */
...
const capabilityCards: { icon: ReactNode; tag: string; title: string; desc: string }[] = [
  ...
  },
  {
    ...
    desc: "Recurring workflows that execute automatically: daily standups with real data, weekly competitive scans, monthly performance reviews. Zundy manages the schedule, execution, and delivery.",
  },
  {
  ...
  },
  {
    ...
    tag: "Apps",
    title: "App building",
    desc: "Describe what you need and Zundy builds it: live dashboards, internal tools, calculators — real web apps with databases, auth, and hosting. Deployed via a link. No design team needed.",
  },
  {
  ...
  },
  {
    ...
    desc: "Operates a real browser — filling forms, navigating complex workflows, scraping data, capturing screenshots. Anything you'd do manually in a browser, Zundy can do programmatically.",
  },
];
...
function SectionWhatCanDo() {
  return (
    <section id="what-zundy-can-do" className="bg-primitive-main-beige py-10 sm:py-12">
      <div className="px-4 sm:px-6 md:px-12 lg:px-20">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 lg:gap-14">
          <h2 className="font-heading h3 text-center sm:h2">What Zundy can do</h2>
          ...
          <div className="dark mx-auto grid w-full max-w-[1440px] grid-cols-1 gap-12 overflow-hidden rounded-section p-8 bg-hero sm:p-12 lg:grid-cols-[minmax(0,29.625rem)_minmax(0,45.375rem)] lg:items-center lg:justify-between lg:gap-16 lg:p-20 xl:gap-20">
            <div className="dark flex w-full min-w-0 flex-col gap-6">
              ...
              <div className="body-main flex flex-col gap-4 font-medium text-white">
                ...
                <p>
                  Zundy is built for organizations. It understands that your marketing team needs campaign
            ...
            <div className="flex min-w-0 items-center justify-center lg:justify-end">
              <img
                ...
                alt="Teams across marketing, engineering, sales, and support using Zundy"
                loading="lazy"
                decoding="async"
                width={1368}
                height={1480}
...
const diffCards: { icon: ReactNode; title: string; desc: string }[] = [
  {
    ...
    desc: "Zundy is a fully hosted service. There's nothing to install on your machine, no infrastructure to maintain, no updates to manage. Compare this to open-source alternatives like OpenClaw, which require a developer to set up, configure, host, and keep running. Zundy works out of the box — for your entire team, not just the person who set it up.",
  },
  {
    icon: <ProductSecureIcon />,
    title: "Secure by design",
    desc: "Zundy stores all credentials in the cloud with enterprise-grade encryption. Your API keys, passwords, and sensitive data never touch a local machine. Self-hosted tools like OpenClaw store credentials directly on your computer — meaning a single prompt injection attack could compromise every password and API key in one breach.",
  },
  {
    icon: <ProductTeamFirstIcon />,
    title: "Team-first, not personal-first",
    desc: "OpenClaw is a personal productivity tool — it excels at managing one person's calendar, email, and tasks. Zundy is purpose-built for teams. It navigates complex multi-channel workspaces, maintains context across different team members' conversations, and creates automations that benefit the entire company.",
  },
  {
    icon: <ProductWorksEverywhereIcon />,
    title: "Works everywhere your team works",
    desc: "Zundy is available in Slack and Microsoft Teams (soon). Not everyone can install a Slack bot. Not everyone uses Teams. Zundy ensures nobody on your team is locked out — regardless of their platform or admin permissions.",
  },
  {
    icon: <ProductNoSetupIcon />,
    title: "No setup required",
    desc: "OpenClaw requires a developer to install, configure, and maintain. Zundy requires a Slack install, a Teams install, or a browser login. Anyone on your team — marketing, sales, support, leadership — can start using it in minutes with zero technical background.",
  },
  {
    icon: <ProductIntegrationsIcon />,
    title: "3,000+ native integrations, zero configuration",
    desc: "Every integration is pre-built, secured with OAuth, and connects in one click. No API keys to paste, no webhooks to wire up, no YAML to edit. Need a tool that isn't in the catalog? Zundy can build custom integrations on the fly.",
  },
];
...
function SectionHowDifferent() {
  return (
    <section id="how-different" className=" py-10 sm:py-12">
      <div className="px-4 sm:px-6 md:px-12 lg:px-20">
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 lg:gap-14">
          <h2 className="font-heading h3 text-center sm:h2">How Zundy is different</h2>
