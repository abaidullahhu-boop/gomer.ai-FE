...
const entries: Entry[] = [
  {
    ...
    intro:
      "Set a personality and custom instructions that shape how Gaspo responds across your entire workspace.",
    items: [
      {
        label: "Workspace personalization",
        description:
          'A new section in Settings lets you pick a personality preset and write custom instructions that apply to every Gaspo conversation in your workspace. Use it to adjust tone, set standing context ("we\'re a B2B SaaS company", "always reply in Spanish"), or reduce sycophancy — the instructions are injected into Gaspo\'s system prompt so they take effect immediately, no restart needed.',
      },
    ],
  },
  {
    ...
    intro:
      "Anthropic's latest frontier model is now available in Gaspo's model picker.",
    items: [
      {
  ...
  },
  {
    ...
    intro:
      "Connect GitHub in read-only mode so Gaspo can browse repos, issues, and PRs without write permissions.",
    items: [
      {
        label: "Read-only GitHub integration",
        description:
          "A separate read-only GitHub connection is now available alongside the existing read-write one. Connect it when you want Gaspo to browse your repos, review code, and read issues or PRs without granting write access — useful for security-conscious teams or when full repo access isn't needed.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description: (
          <>
            The <code>/gaspo-spaces</code> page now shows each space as a thumbnail
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "Output caps for Claude Opus 4.6 / 4.7 and the Sonnet 4 family were raised significantly, so Gaspo can now return much longer reports, drafts, and analyses in a single response without truncation.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Manage Google Ads negative keywords from Gaspo, and get DM replies that stay in thread with quick status acks.",
    items: [
      {
        label: "Google Ads negative keywords",
        description:
          "New tools to list, add, and remove negative keywords at the campaign or ad-group level, with batch updates and match-type support, so you can prune wasted spend without leaving Gaspo.",
      },
      {
        label: "Slack DM replies stay in thread",
        description:
          "When you DM Gaspo about a specific channel thread, replies now land back in that same thread instead of bouncing to the channel root.",
      },
      {
        label: "Quick acks on status checks",
        description:
          "If you ping Gaspo mid-task to ask where things stand, you'll get a short Slack status update first before it resumes the work.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "When Gaspo asks for permission to use a tool in Slack, you can now choose to always approve future uses of the same tool. The preference is saved to your MCP settings so you stop getting re-prompted for tools you trust.",
      },
      {
      ...
      },
      {
        ...
        description:
          "When you're the last admin deleting a workspace, Gaspo now shows exactly which teammates will lose access and how many scheduled tasks each person has, so you know the impact before you confirm.",
      },
      {
    ...
    items: [
      {
        ...
        description:
          "Anthropic's newest frontier model is now available in Gaspo for everyone, with a 1M context window, adaptive thinking, and summarized reasoning output.",
      },
      {
    ...
    items: [
      {
        ...
        description:
          'You can now connect multiple accounts for the same service. For example, link two Gmail inboxes or two YouTube channels and Gaspo gives each connection its own dedicated tools. Manage them individually from the integrations dashboard with per-account disconnect and a simple "Connect another" button.',
      },
    ],
  },
  {
    ...
    intro:
      "Gaspo can now generate spoken audio, transcribe media files, and create AI-powered videos.",
    items: [
      {
  ...
  },
  {
    ...
    intro:
      "Gaspo now handles external shared channels with a private DM handoff and approval before replying.",
    items: [
      {
        label: "External shared channel → DM handoff",
        description:
          "When Gaspo is @mentioned in a Slack Connect channel, it now moves the conversation into a private DM instead of replying publicly. You'll be asked to approve before any response is posted back to the shared thread — keeping cross-org conversations secure by default.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description:
          "You can now ask Gaspo to submit an issue report directly from your Slack conversation. Gaspo will draft the report and ask for your approval before sending — no need to leave the chat.",
      },
    ],
  },
  {
    ...
    intro:
      "Teams can now switch to annual billing, and Gaspo gains new Google Drive and Sheets management tools.",
    items: [
      {
      ...
      },
      {
        ...
        description:
          "Gaspo can now copy and move files in Google Drive, and manage Google Sheets tabs — create, rename, and delete sheets within a spreadsheet.",
      },
      {
        label: "Meta Ads product catalogs",
        description:
          "Gaspo can now create, update, and delete items in your Meta Ads product catalogs, making it easier to manage your ad inventory.",
      },
    ],
  },
  {
    ...
    intro: "GPT-5.4 is now available as a model option in Gaspo.",
    items: [
      {
        label: "GPT-5.4 model",
        description:
  ...
  },
  {
    ...
    intro:
      "Gaspo can now connect to Granola to access and work with your meeting notes.",
    items: [
      {
        label: "Granola integration",
        description:
          "Gaspo can now connect to Granola, giving it access to your meeting notes. Summarize discussions, pull out action items, or reference past meetings — all directly through Gaspo.",
      },
    ],
  },
  {
    ...
    intro:
      "Gaspo automatically picks up where it left off after you connect an integration — no manual confirmation needed.",
    items: [
      {
        label: "Auto-resume after integration connect",
        description:
          'When Gaspo asks you to connect an integration and you complete the OAuth flow, it now automatically picks up where it left off. No more having to manually say "I\'ve connected it" — the conversation continues seamlessly.',
      },
    ],
  },
  {
    ...
    intro:
      "Pick which Slack channels Gaspo joins during setup, and each team member now gets their own personalized skills.",
    items: [
      {
        label: "Channel selection during setup",
        description:
          "When onboarding through the web, you now pick exactly which Slack channels Gaspo joins before the agent starts. No more guessing — you're in control from the first step.",
      },
      {
        label: "Personal skills per team member",
        description:
          "Each person on your team can now have their own personalized Gaspo skills. Different team members see different skills based on their role and access, making Gaspo more relevant to each individual.",
      },
    ],
  },
  {
    ...
    intro:
      "Gaspo now enforces per-user channel privacy — each team member only sees their own channels.",
    items: [
      {
        label: "Slack channel privacy",
        description:
          "When multiple people share a Gaspo workspace, each user's agent now only sees the Slack channels they're actually a member of. Private channels, DMs, and group DMs stay private — matching the access rules you already have in Slack. Access updates automatically when someone joins or leaves a channel.",
      },
      {
        label: "Create group DMs",
        description:
          "You can now ask Gaspo to start a group DM with specific people directly — no approval step needed.",
      },
    ],
  },
  {
    ...
    intro:
      "Gaspo now works in group DMs, scheduled tasks can post under custom names, and you can ask Gaspo to leave channels.",
    items: [
      {
        label: "Group DM support",
        description:
          "Gaspo can now join and participate in group direct messages (multi-person DMs), not just channels and 1:1 conversations. Mention him in any group DM to get started.",
      },
      {
        label: "Custom sender names for scheduled tasks",
        description:
          'Scheduled tasks can now post messages under a custom display name instead of always appearing as "Gaspo."',
      },
      {
        label: "Leave channel on request",
        description:
          "You can now ask Gaspo to leave a Slack channel. Both joining and leaving channels go through a confirmation step so nothing happens by accident.",
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        description:
          "Your team can now choose which AI model Gaspo uses. Gaspo can also pick the optimal model per scheduled task. Cost comparison badges show how much you save with each option.",
      },
      {
  ...
  },
  {
    ...
    intro:
      "Ask Gaspo about your plan and usage, try the new Claude Sonnet 4-6 model, and get real-time Spaces updates.",
    items: [
      {
        label: "Ask Gaspo about your account & billing",
        description:
          "You can now ask Gaspo directly about your subscription, usage, active threads, and integration settings. Just ask about your plan or credits and he'll pull the data for you.",
      },
      {
        label: "Claude Sonnet 4-6 now available",
        description: "New model option added to Gaspo.",
      },
      {
...
export default function ChangelogPage() {
  return (
    <div className="min-h-screen bg-primitive-main-beige">
      <PageMeta
        title="Changelog — Gaspo"
        description="What's new across the Gaspo platform — releases, improvements, and fixes."
        ogTitle="Changelog — Gaspo"
        ogDescription="What's new across the Gaspo platform."
      />
      {/* Hero */}
