  ...
  return (
    <div className="min-h-screen bg-primitive-main-beige">
      <PageMeta
        ...
        description="Learn how Zundy collects, uses, and protects your personal information — data practices, your rights, and security."
        ogTitle="Privacy Policy"
        ogDescription="Learn how Zundy collects, uses, and protects your personal information — data practices, your rights, and security."
      />
      <Nav heroTone="light" />
      <main className="pt-32 pb-24 px-6 md:px-12">
        <div className="max-w-4xl mx-auto w-full">
          ...
          <Section number="1" title="Introduction">
            <p>
              Zundy ("we," "us," or "our") is committed to protecting your privacy. This
          ...
          <Section number="2" title="Information We Collect">
            ...
            <ul>
              ...
              <li>
                ...
                connect to Zundy, as authorized by you.
              </li>
            </ul>
          </Section>
