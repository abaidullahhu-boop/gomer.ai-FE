  ...
  return (
    <>
      <PageMeta
        ...
        description="Connect the tools you use with Viktor."
      />
              ...
              {connectedOnly ? (
                ...
                <div className="flex flex-col items-center gap-3 rounded-xl border border-dashed border-border bg-card px-6 py-12 text-center">
                  ...
                  <button
                    ...
                    className="viktor-focus-ring inline-flex min-h-8 cursor-pointer select-none items-center justify-center rounded-[7px] bg-secondary px-3 py-2 text-xs font-medium text-secondary-foreground transition-[background-color,transform] duration-200 hover:bg-accent active:scale-[0.98]"
                  >
                    Retry
                  </button>
                </div>
