                          ...
                          >
                            ...
                            <td className="px-4 py-3 text-right">
                              <button
                                ...
                                className="viktor-focus-ring inline-flex cursor-pointer items-center gap-1 rounded-[7px] px-2 py-1 text-xs font-medium text-destructive transition-colors hover:bg-destructive/15 disabled:cursor-default disabled:opacity-60"
                              >
                                {busyId === account.id ? (
