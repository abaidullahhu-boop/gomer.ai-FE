...
export default function DashboardSkills() {
  ...
  return (
    <>
      <PageMeta
        title="Skills — Gaspo"
        description="Browse and install pre-built skills that extend Gaspo's functionality."
      />
          ...
          <div className="mx-auto w-full max-w-[1000px]">
            <div className="flex flex-col gap-6">
              ...
              <p className="text-base leading-6 text-muted-foreground">
                Skills are pre-built capabilities that extend Gaspo&apos;s functionality. Install them
                to give Gaspo access to specialized knowledge and workflows.
              </p>
