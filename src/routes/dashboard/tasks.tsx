...
function tabButtonClass(active: boolean) {
  return [
    "gaspo-focus-ring inline-flex min-h-10 cursor-pointer select-none items-center justify-center gap-2 rounded-[7px] border-0 px-4 py-2 text-sm font-medium transition-[background-color,border-color,transform] duration-200 active:scale-[0.98]",
    active
...
export default function DashboardTasks() {
  ...
  return (
    <>
      <PageMeta
        title="Scheduled Tasks — Gaspo"
        description="Manage scheduled tasks for your Gaspo workspace."
      />
          ...
          <div className="mx-auto w-full max-w-[1000px]">
            ...
            <div className="flex flex-col gap-3">
              <p className="text-base leading-6 text-muted-foreground">
                Create a task above, or by talking to Gaspo in chat.
              </p>
                    ...
                    >
                      <div className="flex items-center gap-3 p-4">
                        <button
                          ...
                          className="gaspo-focus-ring flex min-w-0 flex-1 items-center gap-3 text-left"
                        ...
                        {!task.isSystem && (
                          <button
                            ...
                            disabled={busy}
                            className="gaspo-focus-ring rounded-full border border-border p-1.5 text-muted-foreground hover:bg-accent hover:text-foreground disabled:opacity-50"
