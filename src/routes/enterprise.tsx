...
const customerTestimonials = [
  { name: "Boris Wexler", role: "CEO, Space Dinosaurs", saved: "10+ hrs/week", quote: "Zundy is an incredible tool — it was almost instantly adopted by the bulk of my team.", image: avatar("photo-1500648767791-00dcc994a43e") },
  { name: "Robert Tyrrell", role: "Owner, TalentBright", saved: "10+ hrs/week", quote: "It's blown my mind seeing what Zundy can actually do. I'm having real conversations with my partner about investing in an AI tool the way we used to talk about hiring actual people.", image: avatar("photo-1519345182560-3f2917c472ef") },
  { name: "Jordan Dikoum", role: "Co-Founder, UniTru Inc.", saved: "10+ hrs/week", quote: "Zundy is our eyes, ears, and hands. We might really never have to hire someone again.", image: avatar("photo-1506794778202-cad84cf45f1d") },
];
  ...
  return (
    <div className="min-h-screen bg-primitive-main-beige">
      ...
      <StartFreeSection
        ...
        description="Every Zundy Team integration is $30 / month per seat. Unlimited tasks lived and aided with no admin. Bring your team start when it makes 30 minutes."
        points={[
          "SAML + integrations",
          "Users and Teams",
...
const complianceColumns: ComplianceColumnData[] = [
  {
    ...
    rows: [
      {
        t: "Slack-native auth",
        d: "Zundy inherits your existing Slack SSO/SAML, MFA, and provisioning. No separate Zundy password or identity store.",
      },
      {
        t: "Approval policies",
  ...
  },
  {
    ...
    rows: [
      {
        t: "Per-user OAuth",
        d: "Each person connects their own Google, HubSpot, Linear, GitHub, and other tools. Zundy only sees what that user has granted access to. Credentials stay in your SSO layer, never in ours.",
      },
      {
        t: "Retention roadmap",
      ...
      },
      {
        ...
        d: "Skills, memory, and scheduled tasks live inside your Zundy workspace and never cross to another customer.",
      },
    ],
  },
  {
    ...
    rows: [
      {
        t: "Usage reporting",
        d: "The Zundy team can generate usage reports from admin data to support rollout reviews, adoption tracking, and procurement conversations.",
      },
      {
        t: "DPA included",
      ...
      },
      {
        ...
        d: "A dedicated channel in the Zundy Community Slack where you talk to the engineers building Zundy and other power users.",
      },
    ],
  },
];
...
const TEAM_TABS: TeamTab[] = [
    ...
    messages: [
      {
        ...
        body: (
          <>
            <SlackMention>@Zundy</SlackMention>, audit our Google Ads account and flag anything underperforming.
          </>
        ),
      },
      {
    ...
    messages: [
      {
        ...
        body: (
          <>
            <SlackMention>@Zundy</SlackMention> Build a morning briefing covering MRR, signups, and churn. Post it to #business-team every weekday at 8am.
          </>
        ),
      },
      {
    ...
    messages: [
      {
        ...
        body: (
          <>
            <SlackMention>@Zundy</SlackMention> Clone the repo, create a branch, fix this bug, and open a PR.
          </>
        ),
      },
      {
    ...
    messages: [
      {
        ...
        body: (
          <>
            <SlackMention>@Zundy</SlackMention> Excel of every closed-won deal this quarter, by owner and ARR.
          </>
        ),
      },
      {
      ...
      },
      {
        ...
        body: "Research Acme Corp before my 11am call. Pain points, recent news, fit with Zundy.",
        reactions: [{ emoji: "⏳", count: 1 }],
      },
      {
        kind: "zundy",
  ...
  },
  {
    ...
    label: "Leadership",
    icon: LeadershipIcon,
    headline: "Same Zundy, same context, same security policies across the org.",
    messages: [
      {
        kind: "user",
        name: "Mike",
        ...
        body: (
          <>
            <SlackMention>@Zundy</SlackMention> Summarize what happened across all team channels this week.
          </>
        ),
      },
      {
...
function EnterpriseSlackZundyMessage({
  time,
  body,
  reactions,
}: {
  ...
  return (
    <div
      data-variant="zundy"
      className="relative flex w-full text-left isolate slack-message-zundy gap-2 px-[var(--slack-message-pad-x)] py-[var(--slack-message-pad-y)]"
    >
      ...
      <div className="flex flex-col gap-2">
        {messages.map((message, index) =>
          message.kind === "user" ? (
            ...
            <EnterpriseSlackZundyMessage
              key={`zundy-${message.time}-${index}`}
              time={message.time}
              body={message.body}
              reactions={message.reactions}
            />
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-16">
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-4 text-center">
            ...
            <p className="max-w-[570px] body-main text-secondary font-medium">
              Zundy doesn&apos;t pick a department. Same Zundy, same context, same security policies — across
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-16">
          <div className="mx-auto flex max-w-3xl flex-col items-center gap-4 text-center">
            ...
            <h2 className="font-heading h3 text-balance text-primitive-main-dark">
              You can add Zundy in 2 minutes.
            </h2>
...
const ENTERPRISE_FAQS = [
  ...
  { q: "How long does Zundy to install?", a: "Most teams are live in under 10 minutes: install from the Slack App Directory, connect OAuth for the tools you need, and set admin policies." },
  { q: "Do we control which tools Zundy has access to?", a: "Yes. Admins decide which integrations are enabled, which actions require approval, and which scopes each integration uses. Anything can be revoked instantly." },
  { q: "Does Zundy support SSO?", a: "Yes — SAML 2.0 with Okta, Google Workspace, OneLogin, JumpCloud, Microsoft Entra ID, or any standards-compliant IdP. SCIM provisioning is included on Enterprise." },
];
