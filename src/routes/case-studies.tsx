...
const cases: Case[] = [
  ...
  },
  {
    ...
    excerpt:
      "How Hampton's 25-person team started operating like a much larger one, in 44 days with Gaspo.",
...
export default function CaseStudiesPage() {
  ...
  return (
    <div className="min-h-screen bg-primitive-main-beige">
      <PageMeta
        title="Case Studies — Gaspo"
        description="Real stories from teams running on Gaspo. The numbers are the customers'. The tools are theirs. The workflows still run today."
        ogTitle="Case Studies — Gaspo"
        ogDescription="Real stories from teams running on Gaspo."
      />
      {/* Hero + featured case */}
