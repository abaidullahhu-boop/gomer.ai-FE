...
const testimonials = [
  { name: "Maya Chen", role: "CFO, Northwind", saved: "3-5 hrs/week", quote: "Gaspo handles the weekly cash recap I used to dread. Now it's just there in Slack on Monday morning.", image: avatar("photo-1573496359142-b8d87734a5a2") },
  { name: "Jacob Aldridge", role: "Founder, Como Coaching", saved: "10+ hrs/week", quote: "Gaspo may feel expensive for a monthly subscription, but he's the cheapest hire I've ever made — and the only one who acts on my midnight asks.", image: avatar("photo-1507003211169-0a1dd7228f2d") },
  { name: "Richard Comer", role: "VP Eng, Flagship", saved: "10+ hrs/week", quote: "Gaspo takes the morning alerts off my plate. I haven't read a Datadog email in two months and I sleep through the night.", image: avatar("photo-1580489944761-15a19d654956") },
];
...
export default function UseCasesPage() {
  return (
    <div className="min-h-screen bg-primitive-main-beige">
      <PageMeta
        title="Use Cases — One AI employee. Every function. | Gaspo"
        description="Gaspo lives in Slack, connects to 3,200+ tools, and does the work. Media buying, finance, ops, engineering — pick your team's biggest time sink."
        ogTitle="Use Cases — Gaspo"
          ...
          <div className="hero-page-stack-pt relative z-10 mx-auto flex w-full max-w-[1440px] flex-col items-center gap-16 px-5 pb-20 text-center sm:px-8 md:gap-20 md:px-12 md:pb-24 lg:px-20 lg:pb-28">
            <div className="flex w-full max-w-4xl flex-col items-center gap-8 mt-16">
              ...
              <p className="max-w-[630px] font-medium body-main text-secondary">
                Gaspo lives in Slack, connects to 3,200+ tools, and does the work. Media buying,
                finance, ops, engineering. Pick your team&apos;s biggest time sink. Gaspo handles it.
              </p>
