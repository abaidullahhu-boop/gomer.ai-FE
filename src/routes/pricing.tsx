...
export default function PricingPage() {
  return (
    <div className="min-h-screen bg-primitive-main-beige">
      <PageMeta
        title="Pricing — Gaspo"
        description="We'll front you $100. Put Gaspo to work. Start free with $100 in credits — no credit card, no strings. Upgrade when you're ready."
        ogTitle="Pricing — Gaspo"
        ogDescription="Start free with $100 in credits. Credits power everything Gaspo does. No markup on model costs."
        ogUrl="/pricing"
        canonical="/pricing"
      />
      <PricingHero />
            ...
            <div className="flex w-full max-w-5xl flex-col items-center gap-12 text-center">
              <div className="flex flex-col items-center gap-8 sm:gap-12">
                <h1 className="font-heading text-5xl max-sm:text-[2.625rem] leading-[1.05] font-bold tracking-[-0.06em] text-balance sm:text-6xl lg:text-[5rem]">
                  We'll front you <span className="text-[#fff]">$100.</span>
                  <br className="hidden sm:block" /> Put Gaspo to work.
                </h1>
    ...
    <div className="relative flex w-full text-left isolate gap-2 rounded-lg px-[var(--slack-message-pad-x)] py-0 border border-solid border-transparent bg-transparent">
      ...
      <div className="relative z-[1] flex min-w-0 flex-1 flex-col gap-0">
        ...
        {reactions && reactions.length > 0 && (
          <SlackReactions
            initial={reactions}
            pillClassName="inline-flex min-h-6 items-center gap-1 rounded-full border-0 bg-[#fff] px-2 py-0.5 text-xs font-normal text-slack-reaction-pill cursor-pointer transition-colors hover:bg-[var(--slack-reaction-pill-hover-bg)]"
          />
        )}
      </div>
    </div>
          ...
          <div className="lg:col-span-2">
            ...
            >
              <SlackUserMessage
                ...
                body={
                  <>
                    <SlackMention>@Gaspo</SlackMention> we need a competitive analysis — us vs Notion AI, Glean, and Moveworks. Pricing, features, positioning. Make it a PDF I can share with the board
                  </>
                }
              />
              <SlackGaspoMessage
                ...
                body={
                  <>
                    <SlackMention>@Gaspo</SlackMention> ✅ Done. 12-page PDF with feature matrix, pricing comparison, and positioning map. Here&apos;s the executive summary.
                  </>
                }
              />
            </CreditPowerCard>
