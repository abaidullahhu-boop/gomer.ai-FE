...
export default function PricingPage() {
  return (
    <div className="min-h-screen bg-primitive-main-beige">
      <PageMeta
        title="Pricing — Zundy"
        description="We'll front you $100. Put Zundy to work. Start free with $100 in credits — no credit card, no strings. Upgrade when you're ready."
        ogTitle="Pricing — Zundy"
        ogDescription="Start free with $100 in credits. Credits power everything Zundy does. No markup on model costs."
        ogUrl="/pricing"
        canonical="/pricing"
      />
      <PricingHero />
            ...
            <div className="flex w-full max-w-5xl flex-col items-center gap-12 text-center">
              <div className="flex flex-col items-center gap-8 sm:gap-12">
                <h1 className="font-heading text-5xl max-sm:text-[2.625rem] leading-[1.05] font-bold tracking-[-0.06em] text-balance sm:text-6xl lg:text-[5rem]">
                  ...
                  <br className="hidden sm:block" /> Put Zundy to work.
                </h1>
          ...
          <div className="lg:col-span-2">
            ...
            >
              <SlackUserMessage
                ...
                body={
                  <>
                    <SlackMention>@Zundy</SlackMention> we need a competitive analysis — us vs Notion AI, Glean, and Moveworks. Pricing, features, positioning. Make it a PDF I can share with the board
                  </>
                }
              />
              <SlackZundyMessage
                ...
                body={
                  <>
                    <SlackMention>@Zundy</SlackMention> ✅ Done. 12-page PDF with feature matrix, pricing comparison, and positioning map. Here&apos;s the executive summary.
                  </>
                }
              />
            </CreditPowerCard>
