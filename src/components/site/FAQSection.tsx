...
export const DEFAULT_FAQS: FAQItem[] = [
  { q: "What is Gaspo, exactly?", a: "Gaspo is an AI employee that lives in Slack. It has its own computer in the cloud where it writes and runs code to complete tasks. It's not a chatbot — it's a colleague that does real work." },
  { q: "How is Gaspo different from ChatGPT or other AI assistants?", a: "ChatGPT tells you how to do work. Gaspo does it. It connects to your tools, takes action, and ships finished artifacts: PDFs, dashboards, code, campaigns." },
  ...
  { q: "How long does setup take?", a: "Less than 5 minutes. Install Gaspo in Slack or Teams, connect a few tools, and start delegating." },
  { q: "Can I control what Gaspo has access to?", a: "Yes. Admins can scope Gaspo's access per tool, per channel, and per user with granular permissions." },
  { q: "Does Gaspo learn from my company?", a: "Yes. Gaspo builds a private knowledge base of your processes, preferences, and past work — scoped to your workspace only." },
  { q: "What happens if Gaspo makes a mistake?", a: "You can roll back any action, review Gaspo's full execution log, and refine instructions. Gaspo learns from corrections." },
  { q: "Can I try Gaspo for free?", a: "Yes. Every workspace starts with $100 in free credits — no credit card required." },
  ...
  { q: "How does Gaspo handle confidential data?", a: "All data is encrypted, isolated per workspace, and never shared with third parties or used for model training." },
  { q: "Can Gaspo handle scheduled or recurring tasks?", a: "Yes. Schedule any task on a cron — daily reports, weekly audits, monthly invoices — Gaspo runs them in the background." },
  { q: "What languages does Gaspo speak?", a: "Gaspo is fluent in 50+ languages and adapts to your team's tone and vocabulary." },
  { q: "Can multiple teammates use Gaspo at once?", a: "Yes. Gaspo handles parallel conversations and tasks across your entire workspace simultaneously." },
  { q: "How does Gaspo compare to hiring a contractor?", a: "Gaspo is available 24/7, doesn't require onboarding for each task, and costs a fraction of a contractor — while shipping comparable quality work." },
