    ...
    <section className="px-6 py-24">
      <div className="mx-auto max-w-6xl">
        <CapabilityRow
          ...
          body="Don't build flows in a no-code maze. Tell Gaspo the outcome — it figures out which tools to query, when to run, and what to do with the result."
          bullets={[
    ...
    <section className="px-6 py-24 bg-secondary">
      <div className="mx-auto max-w-6xl">
        <CapabilityRow
          ...
          body="Gaspo pulls numbers from every source of truth, writes the narrative, designs the charts, and delivers a polished PDF or live dashboard."
          bullets={[
...
const HOME_HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  {
    number: "/01",
    title: "Connect",
    body: "Install Gaspo from the Slack App Directory or Microsoft Teams. Connect your tools: Stripe, Notion, Google Ads, whatever you use. Takes 2 minutes.",
    visual: "marketplace",
  },
  {
    number: "/02",
    title: "Ask",
    body: 'Talk to Gaspo like a colleague. "Pull our Meta Ads data and compare vs. last month." "Create a Linear issue for the pricing update." "Build me a revenue dashboard."',
    visual: "slack-connect",
  },
  {
    number: "/03",
    title: "Gaspo delivers",
    body: "Gaspo queries your tools, analyzes data, and delivers real outputs: PDFs, spreadsheets, web apps, code. He also schedules recurring tasks and proposes automations you didn't think to ask for.",
    visual: "slack-work",
  },
];
    ...
    <section className="px-6 py-24 bg-secondary">
      <div className="mx-auto max-w-6xl">
        <CapabilityRow
          ...
          body="Gaspo clones your repo, writes the fix on a feature branch, opens a PR with context, and assigns reviewers. Real commits. Real review."
          bullets={[
    ...
    <section className="px-6 py-24">
      <div className="mx-auto max-w-6xl">
        <CapabilityRow
          ...
          icon={Globe}
          title="Gaspo uses the web like you do."
          body="No API? No problem. Gaspo logs in, clicks through, scrapes the dashboard, and pulls the data — securely, in its own sandboxed browser."
          bullets={[
    ...
    <section className="px-6 py-24 bg-secondary">
      <div className="mx-auto max-w-6xl">
        <CapabilityRow
          ...
          body="Everyone on your team works with the same Gaspo. Shared memory, shared integrations, shared context — but private threads when you need them."
          bullets={[
            "Public + private DMs in Slack and Teams",
            "Role-based access for integrations",
            "Audit log of every action Gaspo takes",
          ]}
          visual={
            <div className="bg-background rounded-2xl p-5 w-full max-w-sm shadow-2xl text-foreground space-y-3">
              ...
              {[
                ["Anna", "Gaspo draft the launch email"],
                ["Gaspo", "Sent to Lisa for review ✓", true],
      ...
      <div className="mx-auto max-w-6xl">
        <div className="text-center">
          ...
          <p className="mt-5 text-background/70 max-w-2xl mx-auto">
            Gaspo is built for teams who can't trade speed for security. Every plan ships with the controls auditors ask for.
          </p>
        </div>
...
const ASK_AI_QUERY =
  "I'm evaluating Gaspo, the AI employee for Slack and Microsoft Teams (Gomer.com). What does he do, what are his strengths and weaknesses, and who is he best for?";
            ...
            <div className="relative z-10 flex w-full flex-col items-center gap-16">
              <div className="flex w-full flex-col items-center gap-8">
                ...
                <p className="body-main max-w-[35.625rem] text-white opacity-80 font-medium">
                  Pick your favorite AI and ask what it thinks about Gaspo.
