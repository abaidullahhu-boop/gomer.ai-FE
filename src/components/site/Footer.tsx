...
// Third-party logos keep their brand colour on the black-and-white site; X's mark is black by brand.
function Social({
  label,
  href,
  d,
  color = "text-primitive-main-dark",
}: {
  label: string;
  href: string;
  d: string;
  ...
  return (
    ...
    >
      <svg className={`size-5 shrink-0 ${color}`} viewBox="0 0 24 24" aria-hidden="true">
