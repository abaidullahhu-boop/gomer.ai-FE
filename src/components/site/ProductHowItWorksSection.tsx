...
import gaspoMarketplaceAvatar from "@/assets/images/gaspo-marketplace-avatar.svg";
...
const PRODUCT_STEPS: HowItWorksStep[] = [
  {
    number: "/01",
    title: "Add Gaspo to your workspace",
  ...
  },
  {
    number: "/03",
    title: "Just work",
    body: "Message Gaspo the way you'd message a coworker. It pulls the relevant data, does the work in a secure cloud sandbox, and delivers the result — right back into your conversation.",
    visual: "slack-work",
  },
];
    ...
    return (
      <div className="flex min-w-0 flex-col gap-2 p-6 sm:p-8">
        <SlackUserMessage
          ...
          body={
            <>
              <SlackMention>@Gaspo</SlackMention><span className="text-white"> audit our Meta Ads and Google Ads spend. Compare vs last month.</span>
            </>
          }
        />
        <SlackGaspoMessage
...
export function ProductHowItWorksSection() {
  return (
    <HowItWorksScrollSection
      ...
      steps={PRODUCT_STEPS}
      description='There is no prompt engineering. No workflow builder. No "agent configuration." You describe what you need in plain language. Gaspo figures out how to do it.'
    />
  );
}
