...
import zundyMarketplaceAvatar from "@/assets/images/zundy-marketplace-avatar.svg";
...
const PRODUCT_STEPS: HowItWorksStep[] = [
  {
    number: "/01",
    title: "Add Zundy to your workspace",
  ...
  },
  {
    number: "/03",
    title: "Just work",
    body: "Message Zundy the way you'd message a coworker. It pulls the relevant data, does the work in a secure cloud sandbox, and delivers the result — right back into your conversation.",
    visual: "slack-work",
  },
];
  ...
  return (
    <div className="flex min-w-0 w-full max-w-[438px] flex-col items-start">
      ...
      <div className="relative flex min-w-0 w-full items-center gap-4 overflow-hidden rounded-2xl p-4 shadow-[0_16px_32px_rgba(26,24,41,0.16)]">
        ...
        <img alt="" className="relative z-10 size-14 shrink-0 overflow-hidden rounded-2xl" loading="lazy" src={zundyMarketplaceAvatar} />
        <div className="relative z-10 flex min-w-0 flex-1 items-start">
          <div className="flex min-w-0 flex-1 flex-col gap-1">
            <div className="flex min-w-0 flex-wrap items-center gap-1">
              <p className="text-sm leading-[1.3] font-medium whitespace-nowrap text-[#262219]">Zundy</p>
    ...
    return (
      <div className="flex min-w-0 flex-col gap-2 p-6 sm:p-8">
        <SlackUserMessage
          ...
          body={
            <>
              <SlackMention>@Zundy</SlackMention><span className="text-white"> audit our Meta Ads and Google Ads spend. Compare vs last month.</span>
            </>
          }
        />
        <SlackZundyMessage
...
export function ProductHowItWorksSection() {
  return (
    <HowItWorksScrollSection
      ...
      steps={PRODUCT_STEPS}
      description='There is no prompt engineering. No workflow builder. No "agent configuration." You describe what you need in plain language. Zundy figures out how to do it.'
    />
  );
}
