      ...
      <div className="flex flex-1 flex-col gap-4 p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="zundy-focus-ring inline-flex min-h-8 cursor-pointer select-none items-center justify-center gap-2 rounded-md border-0 bg-btn-primary px-3 py-2 text-xs font-medium text-btn-primary transition-[opacity,transform] duration-200 hover:opacity-90 active:scale-[0.98]"
          >
