    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <button
          type="button"
          onClick={onCopy}
          className="zundy-focus-ring inline-flex min-h-10 w-full cursor-pointer select-none items-center justify-center gap-2 rounded-md border-0 bg-btn-primary px-4 py-2 text-sm font-medium text-btn-primary transition-[opacity,transform] duration-200 hover:opacity-90 active:scale-[0.98]"
        >
        ...
        <div className="flex max-h-[85vh] w-full flex-col gap-4">
          <div className="space-y-2">
            ...
            <div className="text-sm font-medium text-secondary">
              Get 10,000 credits for every friend that adds Zundy to their own Slack workspace.
            </div>
          </div>
