            ...
            <div className="px-3.5 py-3">
              ...
              <div className="mt-3 flex flex-col gap-0.5">
                <div className="flex items-baseline justify-between gap-3">
                  ...
                  <span className="shrink-0 text-sm text-foreground">{billingData.credits.reward}</span>
                </div>
    ...
    <>
      ...
      >
        ...
        <div className="min-w-0 flex-1">
          <div className="truncate text-left text-sm font-medium text-foreground">{user.name}</div>
          <div className="truncate text-left text-xs text-muted-foreground">{user.email}</div>
        </div>
      </button>
      {menu}
    </>
