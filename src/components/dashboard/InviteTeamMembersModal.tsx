  ...
  return (
    <span className="inline-flex items-center gap-1 rounded-md bg-accent px-2 py-0.5 text-sm text-foreground">
      ...
      <button
        ...
        onClick={onRemove}
        className="zundy-focus-ring inline-flex size-4 cursor-pointer items-center justify-center rounded-sm text-muted-foreground transition-colors hover:text-foreground"
      >
        ...
        <div className="flex max-h-[85vh] w-full flex-col gap-4">
          <div className="space-y-2">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              do not change your billing amount in Zundy&apos;s credit-based plans.{" "}
              <Link
          ...
          <div className="flex flex-col gap-3">
            <div className="flex w-full flex-col gap-1.5">
              ...
              <div
                className="zundy-focus-ring flex min-h-10 flex-wrap items-center gap-1.5 rounded-[7px] border border-border bg-secondary px-3 py-[5px] text-base outline-0 focus-within:outline-2 focus-within:outline-offset-2 focus-within:outline-ring"
            ...
            <button
              ...
              className="zundy-focus-ring inline-flex min-h-10 w-full cursor-pointer select-none items-center justify-center gap-2 rounded-[7px] border-0 bg-btn-primary px-4 py-2 text-sm font-medium text-btn-primary transition-[opacity,transform] duration-200 hover:opacity-90 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50 data-[loading=true]:cursor-wait"
            >
              Invite
            </button>
          </div>
