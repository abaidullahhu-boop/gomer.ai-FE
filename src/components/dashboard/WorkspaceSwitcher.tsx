  ...
  return (
    <div ref={ref} className="relative">
      <button
        ...
        className="zundy-focus-ring group flex w-full cursor-pointer items-center gap-2.5 rounded-[7px] border border-sidebar-border bg-sidebar-background/40 px-2.5 py-2 text-left text-foreground transition-colors hover:bg-sidebar-accent"
      >
      ...
      {open ? (
        ...
        >
          {workspaces.map((workspace) => {
            ...
            return (
              <button
                ...
                className="zundy-focus-ring flex w-full cursor-pointer items-center gap-2.5 px-2.5 py-2 text-left transition-colors hover:bg-[#F4F4F5] disabled:cursor-wait"
              >
          ...
          <button
            ...
            className="zundy-focus-ring flex w-full cursor-pointer items-center gap-2.5 px-2.5 py-2 text-left text-sm font-medium text-foreground transition-colors hover:bg-accent"
          >
