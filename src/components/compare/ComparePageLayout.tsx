...
function CompareIntegrationsVisual() {
  return (
    <div className="dark relative flex w-full overflow-hidden rounded-[32px] gradient-dark-1 min-h-[22rem] flex-col items-center justify-center p-4 lg:min-h-[616px] lg:p-16">
      <img
        src={compareVisual3}
        alt="Logos of tools Gaspo integrates with"
        loading="lazy"
        width={1608}
        height={1515}
...
export function ComparePageLayout({ config }: { config: ComparePageConfig }) {
  ...
  function CompareHeroGaspoCard() {
    return (
      <div className="compare-hero-gaspo-card relative min-h-112 overflow-hidden rounded-[36px]">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-4">
                    <p className="body-main text-primitive-main-grey">
                      Gaspo is an autonomous AI employee that lives in your Slack, connects to 3,200+ business
                    ...
                    <p className="body-main text-primitive-main-grey">
                      Choose Gaspo when you need an AI that actually touches your tools and delivers outputs your
                      team can use.
                    </p>
                  </div>
                </div>
                ...
                <tr className="border-b border-border">
                  ...
                  <th className="w-[34%] py-6 pr-4">
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      />
                      <span className="truncate font-medium body-main text-primary">Gaspo</span>
                    </div>
                  </th>
                  ...
                  <tr key={row.feature} className="border-b border-border last:border-b-0">
                    ...
                    <td className="py-6 pr-4 align-top">
                      <div className="flex gap-3">
                        <GaspoCheckBadge />
                        <p className="min-w-0 body-main font-medium text-secondary">{row.gaspo}</p>
                      </div>
                    </td>
                ...
                <article key={row.feature} className="border-b border-border py-6 last:border-b-0">
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="flex gap-3">
                      ...
                      />
                      <p className="min-w-0 body-main text-secondary">{row.gaspo}</p>
                    </div>
                    <div className="flex gap-3">
  ...
  function WhenChooseGaspoHeader() {
    return (
        ...
        <div className="px-4 sm:px-6 md:px-12 lg:px-20">
          <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-12">
            ...
            <div className="mx-auto grid w-full max-w-[66.5rem] gap-10 lg:grid-cols-2 lg:gap-8 xl:gap-12">
              <WhenChooseColumn
                variant="gaspo"
                label="Choose Gaspo if:"
                items={config.whenToChoose.gaspoWhen}
                header={<WhenChooseGaspoHeader />}
              />
              <WhenChooseColumn
                variant="competitor"
