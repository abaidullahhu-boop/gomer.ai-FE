...
function WhenChooseLabel({ children, variant }: { children: string; variant: "zundy" | "competitor" }) {
  return (
    <div className="flex items-center justify-center gap-3 px-1 sm:gap-5">
      ...
      <span
        className={`relative z-30 inline-flex h-8 items-center justify-center rounded-full px-4 text-base leading-[1.3] font-medium tracking-[0.01em] sm:px-5 sm:text-[1.125rem] ${
          variant === "zundy" ? "bg-[#5c28d7]/16 text-[#5c28d7]" : "bg-[#1a182b]/5 text-secondary"
        }`}
      >
        {children}
      </span>
...
function CompareIntegrationsVisual() {
  return (
    <div className="dark relative flex w-full overflow-hidden rounded-[32px] gradient-dark-1 min-h-[22rem] flex-col items-center justify-center p-4 lg:min-h-[616px] lg:p-16">
      <img
        src={compareVisual3}
        alt="Logos of tools Zundy integrates with"
        loading="lazy"
        width={1608}
        height={1515}
...
export function ComparePageLayout({ config }: { config: ComparePageConfig }) {
  ...
  function CompareHeroZundyCard() {
    return (
      <div className="compare-hero-zundy-card relative min-h-112 overflow-hidden rounded-[36px]">
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex flex-col gap-4">
                    <p className="body-main text-primitive-main-grey">
                      Zundy is an autonomous AI employee that lives in your Slack, connects to 3,200+ business
                    ...
                    <p className="body-main text-primitive-main-grey">
                      Choose Zundy when you need an AI that actually touches your tools and delivers outputs your
                      team can use.
                    </p>
                  </div>
                </div>
                ...
                <tr className="border-b border-border">
                  ...
                  <th className="w-[34%] py-6 pr-4">
                    <div className="flex min-w-0 items-center gap-3">
                      ...
                      />
                      <span className="truncate font-medium body-main text-primary">Zundy</span>
                    </div>
                  </th>
                  ...
                  <tr key={row.feature} className="border-b border-border last:border-b-0">
                    ...
                    <td className="py-6 pr-4 align-top">
                      <div className="flex gap-3">
                        <ZundyCheckBadge />
                        <p className="min-w-0 body-main font-medium text-secondary">{row.zundy}</p>
                      </div>
                    </td>
                ...
                <article key={row.feature} className="border-b border-border py-6 last:border-b-0">
                  ...
                  <div className="flex flex-col gap-5">
                    <div className="flex gap-3">
                      ...
                      />
                      <p className="min-w-0 body-main text-secondary">{row.zundy}</p>
                    </div>
                    <div className="flex gap-3">
  ...
  function WhenChooseZundyHeader() {
    return (
        ...
        <div className="px-4 sm:px-6 md:px-12 lg:px-20">
          <div className="mx-auto flex w-full max-w-7xl flex-col items-center gap-12">
            ...
            <div className="mx-auto grid w-full max-w-[66.5rem] gap-10 lg:grid-cols-2 lg:gap-8 xl:gap-12">
              <WhenChooseColumn
                variant="zundy"
                label="Choose Zundy if:"
                items={config.whenToChoose.zundyWhen}
                header={<WhenChooseZundyHeader />}
              />
              <WhenChooseColumn
                variant="competitor"
