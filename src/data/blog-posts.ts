  ...
  return [
    {
      ...
      a: "No. Viktor is designed so engineers can describe what they need in plain language and iterate from a working starting point. You can go from idea to a shareable app in a single session.",
    },
    {
      q: "Can my whole team use the same workflow?",
      a: "Yes. Apps and automations built in Viktor can be shared across your workspace with permissions, versioning, and audit trails so the whole team works from one source of truth.",
    },
    {
      q: "How does Viktor connect to our existing tools?",
      a: "Viktor integrates with 3,000+ apps through managed authentication. Connect your stack once and Viktor can read, write, and orchestrate work across your tools from Slack or Teams.",
    },
    {
      q: "Is this suitable for production engineering work?",
      a: "Yes. Teams use Viktor for client deliverables, internal calculations, reports, and production deployments — with review-first defaults and SOC 2 compliant infrastructure.",
    },
  ];
}
  ...
  return [
    {
      ...
      paragraphs: [
        `${topic} is one of the highest-leverage ways engineering teams are using Viktor today. Instead of rebuilding the same workflow in spreadsheets or one-off scripts, you package the logic once and let Viktor run it on demand — or on a schedule — from Slack.`,
    ...
    {
      title: "How it works in Viktor",
      subsections: [
        {
          title: "Describe the workflow",
          paragraphs: [
            "Start in Slack or the Viktor App Builder. Describe the inputs, the calculation or extraction logic, and the output you need — a PDF, a dashboard, a web app, or a data export.",
          ],
        },
        {
          title: "Connect your tools",
          paragraphs: [
            "Wire up the files, APIs, and databases your workflow depends on. Viktor handles authentication and keeps credentials out of prompts.",
          ],
        },
        {
    ...
    },
    {
      ...
      codeBlock: `@Viktor run the ${topic.toLowerCase()} workflow on the latest project files
...
export const blogPosts: BlogPost[] = [
  {
    ...
    sections: [
      ...
      },
      {
        ...
        codeBlock: `@Viktor every Friday at 4pm, pull this week's closed-won deals from HubSpot
...
post it for me to review before it goes out.`,
  ...
  },
  {
    ...
    title: "Build engineering apps with Claude Code + Viktor SDK, and share them safely on the Viktor platform",
    excerpt:
      "Learn how to build a real engineering app with Claude Code and the Viktor SDK, from setup and development to debugging and visualization.",
    subtitle:
      "A practical guide to building, debugging, and sharing engineering apps with Claude Code and the Viktor SDK.",
    date: "Jun 01, 2026",
    author: "Viktor Team",
    keyTakeaways: [
      "Claude Code and the Viktor SDK let you go from prompt to production app without leaving your editor.",
      "The SDK handles auth, deployment, and workspace sharing so you focus on engineering logic.",
      "Apps built this way inherit Viktor's permissions, versioning, and review workflows.",
    ...
    intro: [
      "Engineering teams no longer need a separate web team to ship internal tools. With Claude Code and the Viktor SDK, you describe the calculation or workflow, iterate in code, and publish to your workspace in one flow.",
    ...
    sections: standardSections("Claude Code + Viktor SDK apps", [
      "Use Claude Code for fast iteration on app logic and UI.",
      "Use the Viktor SDK for deployment, integrations, and workspace APIs.",
      "Publish to Viktor when the app is ready for teammates.",
    ]),
    faqs: faqs("Claude Code + Viktor SDK"),
  },
  {
    slug: "4-engineering-workflows-automate-ai-viktor",
    title: "4 Engineering workflows you can easily automate with AI in Viktor",
    excerpt:
      "Discover 4 practical ways engineers can use AI inside Viktor apps, from extracting borehole data and reading PDFs to querying IFC models.",
    subtitle:
      "Four real engineering workflows — borehole extraction, PDF parsing, IFC queries, and report generation — automated with AI in Viktor.",
    date: "May 19, 2026",
    author: "Viktor Team",
    keyTakeaways: [
    ...
    intro: [
      "Engineers spend a surprising amount of time moving data between formats — PDFs to spreadsheets, borehole logs to design inputs, IFC files to quantity takeoffs. Viktor automates those bridges with AI that understands engineering context.",
  ...
  },
  {
    ...
    title: "From Claude Code to Production: How Engineering Teams Scale AI Automation with Viktor",
    excerpt:
      "Engineering firms are starting to combine Claude Code and Viktor to automate engineering workflows faster and at larger scale.",
    subtitle:
      "How engineering firms move from prototype automations to production-grade workflows with Claude Code and Viktor.",
    date: "May 14, 2026",
    author: "Viktor",
    keyTakeaways: [
      "Prototypes in Claude Code become production apps on Viktor with one publish step.",
      "Scaling means permissions, versioning, and audit trails — not more scripts on laptops.",
      "Teams keep engineering logic in code while Viktor handles infra and integrations.",
    ...
    intro: [
      "The gap between a working prototype and something your whole firm can rely on is where most AI automation projects stall. Viktor closes that gap by giving engineering teams a path from Claude Code experiments to managed production apps.",
    ],
    sections: standardSections("Claude Code to production", [
      "Prototype locally with Claude Code.",
      "Publish to Viktor for managed deployment.",
  ...
  },
  {
    ...
    title: "What's new in Viktor (May 2026)",
    excerpt:
      "Viktor's May 2026 updates make it easier to build, manage, and collaborate on engineering apps. From new App Builder capabilities to smarter app management.",
    subtitle:
    ...
    intro: [
      "May was a big month for teams building and sharing engineering apps on Viktor. Here is what shipped and how to use it.",
    ],
    sections: [
      {
        title: "App Builder",
      ...
      },
      {
        title: "Collaboration",
        paragraphs: [
          "Teammates can comment on specific app versions and compare outputs side by side — so design reviews happen in Viktor, not in email threads.",
        ],
      },
    ],
    faqs: faqs("Viktor May 2026 updates"),
  },
  {
    ...
    subtitle:
      "Five Python libraries structural engineers use inside Viktor apps — from analysis APIs to parametric modeling.",
    date: "May 11, 2026",
    ...
    keyTakeaways: [
      ...
      "Viktor wraps these libraries in shareable apps your whole team can run.",
    ],
    intro: [
      "Python is the lingua franca of structural automation. These five libraries show up in nearly every Viktor app we see from structural teams — and AI makes wiring them together faster than ever.",
    ],
    sections: [
      {
        title: "The five libraries",
        table: {
          headers: ["Library", "Use case", "In Viktor"],
          rows: [
      ...
      ...standardSections("structural Python automation", [
        ...
        "Wrap logic in a Viktor app for sharing and review.",
  ...
  },
  {
    ...
    title: "How InfraSpace and Viktor improve early-stage infrastructure planning with AI",
    excerpt:
      "Combining route optimization with engineering analysis for roads, transmission lines, and heavy transport projects.",
    subtitle:
      "Route optimization meets engineering analysis — how InfraSpace and Viktor accelerate early-stage infrastructure planning.",
    date: "May 07, 2026",
    author: "Viktor",
    keyTakeaways: [
      "Early-stage planning benefits from combining GIS route data with engineering constraints.",
      "InfraSpace handles corridor optimization; Viktor runs the engineering checks.",
    ...
    intro: [
      "Infrastructure projects live or die in early planning. Combining InfraSpace's route optimization with Viktor's engineering analysis gives teams a single workflow from corridor selection to design validation.",
    ],
    sections: standardSections("infrastructure planning with InfraSpace", [
      "Export route alternatives from InfraSpace.",
      "Run engineering checks in Viktor against your standards.",
  ...
  },
  {
    ...
    title: "How to build geotechnical AI agents in Viktor for borehole logs and footing design",
    excerpt:
      "Learn how to build geotechnical AI agents to extract data from borehole logs and reports, automate footing design inputs.",
    subtitle:
      "Build geotechnical AI agents that extract borehole data and automate footing design inputs in Viktor.",
    date: "May 04, 2026",
    ...
    intro: [
      "Geotechnical engineers still re-type borehole data from PDFs into design spreadsheets. Viktor agents read the logs, structure the data, and hand it to your footing design app — with review at every step.",
    ],
  ...
  },
  {
    ...
    subtitle:
      "Turn legacy PDF specifications into living, calculable Viktor apps — without rewriting your engineering logic.",
    date: "Apr 29, 2026",
    author: "Viktor Team",
    keyTakeaways: [
      ...
      "You keep the engineering logic; Viktor handles the UI and deployment.",
    ...
    sections: standardSections("PDF to app", [
      ...
      "Build the calculation layer in Python or Viktor's App Builder.",
  ...
  },
  {
    ...
    sections: standardSections("Excel to web migration", [
      ...
      "Rebuild logic in Viktor with side-by-side validation.",
  ...
  },
  {
    ...
    title: "Vibe coding in Viktor: a hands-on tutorial",
    excerpt:
    ...
    keyTakeaways: [
      ...
      "Viktor's App Builder turns prompts into working UIs you refine in conversation.",
    ...
    sections: standardSections("vibe coding in Viktor", [
  ...
  },
  {
    ...
    intro: [
      "The first Viktor app is easy. The tenth requires governance — who can edit, who can run, what version went to the client. These practices keep shared apps trustworthy as adoption spreads.",
    ],
  ...
  },
  {
    ...
    title: "How Civil Engineers Use Viktor to Automate Reports",
    excerpt:
      "From design checks to fully formatted client deliverables in a fraction of the time.",
    subtitle:
      "From design checks to fully formatted client deliverables — how civil engineers automate reports with Viktor.",
    date: "Apr 03, 2026",
    author: "Viktor Team",
    tags: ["Civil"],
    keyTakeaways: [
      "Report automation starts with templating your firm's standard sections.",
      "Viktor pulls calculation results and inserts them into branded PDFs.",
    ...
    intro: [
      "Civil engineers produce enormous documentation load. Viktor automates the assembly — pulling numbers from calculations, formatting to your template, and routing for review.",
    ],
  ...
  },
  {
    ...
    title: "Visualizing 3D models in your Viktor app",
    excerpt:
      "A walk-through of Viktor's 3D viewer and how to integrate it with parametric models.",
    subtitle:
      "Walk-through of Viktor's 3D viewer and integrating it with parametric engineering models.",
    date: "Mar 28, 2026",
    author: "Viktor Team",
    keyTakeaways: [
      "Viktor's 3D viewer embeds directly in App Builder UIs.",
    ...
    intro: [
      "3D visualization helps engineers and clients understand designs faster than tables alone. Viktor's built-in viewer connects to your parametric models inside shareable apps.",
    ],
    sections: standardSections("3D visualization in Viktor", [
  ...
  },
  {
    ...
    title: "The Engineer's Guide to API integrations in Viktor",
    excerpt:
      "Connect Viktor apps to your favorite engineering tools and external services with minimal glue code.",
    subtitle:
      "Connect Viktor apps to engineering tools and external services with minimal glue code.",
    date: "Mar 23, 2026",
    author: "Viktor Team",
    keyTakeaways: [
      "Viktor manages OAuth and API keys — credentials never enter prompts.",
    ...
    intro: [
      "API integrations are how Viktor apps become part of your real workflow — pulling live data from HubSpot, pushing results to SharePoint, triggering analysis on your solver cluster.",
    ],
  ...
  },
  {
    ...
    title: "How to deploy your first Viktor app to production",
    excerpt:
    ...
    intro: [
      "Deploying your first Viktor app to production is simpler than traditional web hosting — no servers to manage, no CI pipeline to wire up. This guide covers the path from prototype to firm-wide rollout.",
    ],
  ...
  },
  {
    ...
    intro: [
      "Parametric models power the best Viktor apps. These patterns — drawn from production apps across civil, structural, and infrastructure teams — help you build models that scale.",
    ],
  ...
  },
  {
    ...
    excerpt:
      "A real-world case study of migrating a fleet of internal spreadsheets to managed Viktor applications.",
    subtitle:
      "Case study: migrating a fleet of internal spreadsheets to managed Viktor apps in 30 days.",
    date: "Mar 06, 2026",
    author: "Viktor",
    keyTakeaways: [
    ...
    intro: [
      "One mid-size engineering firm migrated twelve business-critical spreadsheets to Viktor apps in thirty days. Here is the playbook they used — and what they would do differently.",
    ],
  ...
  },
  {
    ...
    title: "Working with IFC and BIM data in Viktor",
    excerpt:
      "Open, parse, and manipulate BIM models with Viktor's BIM toolkit.",
    subtitle:
      "Open, parse, and manipulate IFC and BIM models with Viktor's BIM toolkit.",
    date: "Mar 01, 2026",
    author: "Viktor Team",
    keyTakeaways: [
      "IFC files parse into queryable element trees inside Viktor apps.",
    ...
    intro: [
      "BIM data is only useful when engineers can query it without opening a heavyweight desktop viewer. Viktor's BIM toolkit makes IFC models accessible inside shareable apps and Slack workflows.",
    ],
    sections: standardSections("IFC and BIM in Viktor", [
  ...
  },
  {
    ...
    title: "Building a digital twin with Viktor and Azure",
    excerpt:
      "Combine sensor data with parametric models for true real-time digital twins.",
    subtitle:
      "Combine sensor data with parametric models for real-time digital twins on Viktor and Azure.",
    date: "Feb 24, 2026",
    author: "Viktor Team",
    keyTakeaways: [
      "Digital twins need live sensor feeds and engineering models in one place.",
      "Azure IoT Hub streams data Viktor apps consume in real time.",
    ...
    intro: [
      "Digital twins bridge the gap between physical assets and engineering models. Viktor and Azure together let teams build twins that update live — without custom infrastructure teams.",
    ],
    sections: standardSections("digital twins with Azure", [
      "Connect Azure IoT Hub to your Viktor workspace.",
  ...
  },
  {
    ...
    title: "What's new in Viktor (February 2026)",
    excerpt:
    ...
    faqs: faqs("Viktor February 2026 updates"),
  },
  {
    slug: "ai-assisted-code-review-engineering-apps",
    title: "AI-assisted code review for engineering apps",
    excerpt:
      "How Viktor's AI reviewer catches calculation errors before they reach production.",
    subtitle:
      "How Viktor's AI reviewer catches calculation errors before engineering apps reach production.",
    date: "Feb 12, 2026",
    author: "Viktor Team",
    keyTakeaways: [
    ...
    intro: [
      "Engineering apps carry real liability when calculations are wrong. Viktor's AI reviewer acts as a first pass — catching errors that are easy to miss in manual review.",
    ],
  ...
  },
  {
    ...
    keyTakeaways: [
      ...
      "Viktor's SDK integrates with standard Python test runners.",
    ],
    intro: [
      "Unit tests are how engineering teams sleep at night. These practices — used by firms running production Viktor apps — keep calculation logic trustworthy as apps evolve.",
    ],
