...
export const taskletCompareConfig: ComparePageConfig = {
  meta: {
    title: "Gaspo vs Tasklet — Slack Coworker vs Cloud Agent",
    description:
      "Compare Gaspo and Tasklet. Gaspo lives in Slack and ships work where your team already is. Tasklet runs cloud agents you manage from a web app.",
    ogTitle: "Gaspo vs Tasklet — Slack Coworker vs Cloud Agent",
    ogDescription:
      "How Gaspo and Tasklet stack up on Slack-native workflows, integrations, deliverables, pricing, and team collaboration.",
  },
  hero: {
    titleLine1: "Gaspo vs Tasklet:",
    titleLine2: "Slack Coworker vs Cloud Agent",
    subtitle:
      "Tasklet builds cloud agents from plain English. Gaspo is an AI employee that lives in Slack, connects to 3,200+ tools, and ships work where your team already is.",
  ...
  rows: [
    ...
    },
    {
      ...
      gaspo: "Inside Slack and Microsoft Teams. @mention Gaspo like a colleague. Work happens where your team already is.",
      competitor:
    ...
    },
    {
      ...
      gaspo:
        "Board-ready PDFs, Excel spreadsheets, PowerPoint decks, full-stack web applications (Gaspo Spaces), code commits, and pull requests.",
      competitor:
    ...
    },
    {
      ...
      gaspo:
        "Multi-user by default. Everyone @mentions Gaspo in Slack with shared context, automations, and memory.",
      competitor:
  ...
  featureSections: [
    {
      title: "Gaspo works in Slack. Tasklet works from a dashboard.",
      paragraphs: [
        "With Gaspo, you @mention it in a channel: Pull our Stripe revenue, compare to Meta Ads spend, and post a PDF summary here. Five minutes later, the report is in the thread. Your whole team sees it.",
        ...
        "Both automate real work. Gaspo keeps the human-AI collaboration where your team already lives. Tasklet centralizes it in a separate product.",
      ],
    },
    {
      title: "One AI coworker vs. a fleet of cloud agents.",
      paragraphs: [
        "Gaspo is one AI employee for your workspace. Shared memory, shared context, shared automations. When someone asks about last week's numbers, Gaspo already knows — because it ran the report for someone else yesterday.",
        ...
        "For teams that want simplicity — one coworker in Slack who does everything — Gaspo's model wins. For teams that want granular agent specialization, Tasklet's multi-agent approach has merit.",
      ],
    },
    {
      title: "Professional deliverables vs. data outputs.",
      paragraphs: [
        "Gaspo delivers board-ready PDFs with charts, formatted Excel spreadsheets, PowerPoint decks, and even full-stack web applications (Gaspo Spaces). These aren't raw data dumps — they're polished outputs your team can present.",
        ...
        "If your team needs presentation-quality deliverables shipped directly in Slack, Gaspo's output layer is built for that. If you need lightweight recurring automations configured in plain English, Tasklet is strong there too.",
      ],
    },
  ],
  whenToChoose: {
    title: "When to choose Tasklet vs Gaspo",
  ...
  testimonials: [
    {
      ...
      role: "CEO, Growably",
      quote:
        "Tasklet was great for automations, but our team kept forgetting to check the dashboard. Gaspo lives where we already are — in Slack.",
    },
    {
      name: "Sam Kopelman",
      role: "CEO, Givr",
      quote:
        "We had Tasklet agents running reports. Gaspo turned those reports into board-ready PDFs delivered in our channels.",
    },
    {
      name: "Antonín Štětina",
      role: "CEO, KULINA Group",
      quote:
        "One Gaspo in Slack replaced three Tasklet agents and the context-switching between apps.",
    },
  ],
  faqs: [
    {
      q: "Can Tasklet and Gaspo do similar things?",
      a: "Yes — both connect to business tools and automate workflows. The difference is where you interact: Gaspo in Slack conversations, Tasklet in a web app dashboard.",
    },
    {
    ...
    },
    {
      ...
      a: "Both are designed for plain-English setup. Gaspo has the edge for teams that want zero context switching — everything happens in Slack.",
    },
    {
      q: "Is my data safe?",
