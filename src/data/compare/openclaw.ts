...
export const openclawCompareConfig: ComparePageConfig = {
  meta: {
    title: "Gaspo vs OpenClaw — Managed AI Employee vs DIY Agent",
    description:
      "Compare Gaspo and OpenClaw side-by-side. Gaspo is production-ready in Slack with 3,200+ integrations. OpenClaw requires self-hosting or managed setup.",
    ogTitle: "Gaspo vs OpenClaw — Managed AI Employee vs DIY Agent",
    ogDescription:
      "How Gaspo and OpenClaw stack up on setup, integrations, security, deliverables, and team workflows.",
  },
  hero: {
    titleLine1: "Gaspo vs OpenClaw:",
    titleLine2: "From DIY Agent to AI Employee",
    subtitle:
      "OpenClaw proved the world wants AI agents that do real work. Gaspo is what happens when you want it to just work.",
  ...
  rows: [
    ...
    },
    {
      ...
      gaspo: "Inside your Slack (or Microsoft Teams). @mention Gaspo like a colleague. Zero context switching.",
      competitor:
    ...
    },
    {
      ...
      gaspo:
        "Board-ready PDFs, Excel spreadsheets, PowerPoint decks, full-stack web applications (Gaspo Spaces), code commits, and more.",
      competitor:
    ...
    {
      feature: "Pricing",
      gaspo: "Free starter ($100 credits) · Team $50/mo per workspace — not per seat",
      competitor:
    ...
    },
    {
      feature: "Memory",
      gaspo:
        "Persistent company memory shared across your entire workspace. Gaspo learns your tools, team structure, and processes over time.",
      competitor:
    ...
    },
    {
      ...
      gaspo:
        "Multi-user by default. Everyone in your Slack workspace can @mention Gaspo with shared context, automations, and memory.",
      competitor:
    ...
    {
      feature: "Setup",
      gaspo: "Install from Slack App Directory. Connect integrations via OAuth. Takes under 5 minutes. Free to start.",
      competitor:
  ...
  featureSections: [
    {
      ...
      paragraphs: [
        "When you ask Gaspo to audit your ad spend, it pulls live data from Meta Ads and Google Ads, cross-references with Stripe revenue, and delivers a polished PDF in your Slack thread — in under 5 minutes. No configuration files. No webhook debugging.",
        ...
        "Gaspo gives you the outcomes without the ops burden. OpenClaw gives you the building blocks if you have engineers to assemble them.",
      ],
    },
    {
      title: "Slack-native from install, not after a weekend of DevOps.",
      paragraphs: [
        "Gaspo installs from the Slack App Directory in one click. Your team @mentions it immediately — no Gateway URLs, no signing secrets, no VPS provisioning.",
        ...
        "Managed options like SlackClaw close the gap on setup time, but Gaspo was built as a managed product from day one — with enterprise security, professional deliverables, and 3,200+ integrations included.",
      ],
    },
    {
      title: "3,200+ managed integrations vs. build-your-own connections.",
      paragraphs: [
        "Gaspo connects to your business tools with managed OAuth. One click to connect Stripe, HubSpot, Meta Ads, Google Ads, Notion, Linear, GitHub, and thousands more.",
        ...
        "For business teams that need cross-tool workflows today — not after a sprint of integration work — Gaspo's managed connection layer is the faster path to value.",
      ],
    },
  ],
  whenToChoose: {
    title: "When to choose OpenClaw vs Gaspo",
  ...
  testimonials: [
    {
      ...
      role: "CEO, Growably",
      quote:
        "We tried self-hosting an agent framework first. Gaspo got us to production in a day — with better deliverables and zero ops.",
    },
    {
      name: "Sam Kopelman",
      role: "CEO, Givr",
      quote:
        "OpenClaw is impressive if you have a dev team to run it. Gaspo is impressive if you have a business to run.",
    },
    {
      name: "Antonín Štětina",
      role: "CEO, KULINA Group",
      quote:
        "We didn't want to become an AI infrastructure company. Gaspo let us focus on our actual work.",
    },
  ],
  faqs: [
    {
      q: "Is Gaspo based on OpenClaw?",
      a: "No. Gaspo is a fully managed AI employee built for business teams. It shares the goal of autonomous agents in Slack, but with a different architecture optimized for production deliverables and enterprise security.",
    },
    {
      q: "Can I migrate from OpenClaw to Gaspo?",
      a: "Yes. Connect your integrations via OAuth, describe your existing workflows to Gaspo, and it will replicate them — often with better deliverables and less maintenance.",
    },
    {
      q: "What about OpenClaw's open-source flexibility?",
      a: "If you need to modify agent source code or run on your own hardware, OpenClaw is the right choice. If you need an AI employee that ships work today, Gaspo is faster.",
    },
    {
