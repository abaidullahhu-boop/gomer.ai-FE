...
export const chatgptCompareConfig: ComparePageConfig = {
  meta: {
    title: "Zundy vs ChatGPT — The AI That Does the Work",
    description:
      "Compare Zundy and ChatGPT side-by-side. Zundy connects to 3,000+ tools and ships real work in Slack — ChatGPT talks about it.",
    ogTitle: "Zundy vs ChatGPT — The AI That Does the Work",
    ogDescription:
      "How Zundy and ChatGPT stack up on integrations, deployment, pricing, security, and reliability.",
  },
  hero: {
    titleLine1: "Zundy vs ChatGPT:",
    titleLine2: "The AI That Does the Work",
    subtitle:
      "ChatGPT answers your questions. Zundy connects to your tools, runs your reports, and delivers real outputs. One is a chatbot. The other is a coworker.",
  ...
  rows: [
    ...
    },
    {
      ...
      zundy: "Inside your Slack (or Microsoft Teams). You @mention Zundy like a colleague.",
    ...
    },
    {
      feature: "Memory",
      zundy:
        "Persistent company memory. Zundy learns your tools, preferences, team structure, and processes. Gets smarter about your business every week.",
      competitor:
    ...
    },
    {
      ...
      zundy:
        "Multi-user. Everyone in your Slack workspace can @mention Zundy. Shared context, shared automations, shared memory.",
      competitor:
  ...
  featureSections: [
    {
      title: "Zundy does the work. ChatGPT talks about it.",
      paragraphs: [
        "ChatGPT generates text responses. Zundy generates results. When you ask Zundy to audit your ad spend, it pulls live data from Meta Ads and Google Ads, cross-references with Stripe revenue, analyzes trends vs. last month, and delivers a polished PDF report with charts, tables, and an executive summary. That PDF is in your Slack thread in under 5 minutes.",
        "With ChatGPT, you'd describe your data in the chat, get a text analysis back, then manually create the report yourself.",
        "The difference isn't intelligence. Both use frontier AI models. The difference is that Zundy is connected to your tools and authorized to act. ChatGPT can think. Zundy can think and do.",
      ],
    },
    {
      title: "A teammate in Slack, not a tab in your browser.",
      paragraphs: [
        "Zundy lives where your team already works. You @mention it in a channel or DM it directly, just like messaging a colleague. It sees the conversation context, knows who's asking, and remembers what you discussed last week.",
        ...
        "Zundy's integration into Slack means your entire team benefits. When Zundy automates a weekly report, everyone in the channel sees it. When Zundy learns something about your Stripe account, that knowledge is available to everyone who asks. There's no copy-pasting between apps.",
      ],
    },
    {
      title: "3,200+ integrations vs. copy-paste.",
      paragraphs: [
        "Zundy connects to your business tools with managed OAuth. One click to connect Stripe, HubSpot, Meta Ads, Google Ads, Notion, Linear, GitHub, and thousands more. Zundy can read and write data across all of them in a single request.",
  ...
  whenToChoose: {
    title: "When to choose ChatGPT vs Zundy",
  ...
  testimonials: [
    {
      ...
      role: "CEO, Growably",
      quote:
        "We replaced four different ChatGPT seats with one Zundy workspace. The team actually uses it because it lives where they already work.",
    },
    {
      name: "Sam Kopelman",
      role: "CEO, Givr",
      quote: "ChatGPT was helpful. Zundy is operational. It runs the work, not just the answers.",
    },
    {
  ...
  faqs: [
    {
      q: "Is Zundy a replacement for ChatGPT?",
      a: "For team workflows — yes. For personal Q&A in a browser tab, ChatGPT still wins. Many of our customers run both.",
    },
    {
      q: "Do I have to move my team off ChatGPT to use Zundy?",
      a: "No. Zundy lives in Slack and Teams next to your existing tools. Try it on one workflow first and grow from there.",
    },
    {
      q: "How is pricing different from a ChatGPT subscription?",
      a: "Zundy charges per task that runs, not per seat. Invite the whole company; you only pay for the work that ships.",
    },
    {
      q: "Is my data safe?",
