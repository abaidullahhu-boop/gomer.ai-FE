...
export const claudeInSlackCompareConfig: ComparePageConfig = {
  meta: {
    title: "Gomer vs Claude in Slack — Coworker vs Assistant",
    description:
      "Compare Gomer and Claude in Slack. Claude drafts and summarizes. Gomer connects to 3,200+ tools and ships real work autonomously.",
    ogTitle: "Gomer vs Claude in Slack — Coworker vs Assistant",
    ogDescription:
      "How Gomer and Claude in Slack stack up on actions, integrations, deliverables, pricing, and team workflows.",
  },
  hero: {
    titleLine1: "Gomer vs Claude in Slack:",
    titleLine2: "Coworker vs Assistant",
    subtitle:
      "Claude in Slack helps you draft and summarize. Gomer connects to your tools, runs your reports, and delivers real outputs. One assists. The other executes.",
  ...
  rows: [
    ...
    },
    {
      ...
      gomer: "Inside Slack and Microsoft Teams. @mention Gomer like a colleague with full team access.",
      competitor:
  ...
  featureSections: [
    {
      title: "Gomer executes. Claude assists.",
      paragraphs: [
        "Ask Gomer to audit your ad spend and you get a polished PDF with live data from Meta Ads, Google Ads, and Stripe — delivered in your Slack thread in minutes. Gomer pulled the data, ran the analysis, and formatted the report.",
        ...
        "Both use frontier AI models. The difference is authorization and connection. Gomer is wired into your tools and empowered to act. Claude is wired into your conversations and empowered to advise.",
      ],
    },
    {
      title: "Shared team AI vs. individual assistant accounts.",
      paragraphs: [
        "Gomer is one AI employee for your whole workspace. When it learns your Stripe billing patterns, that knowledge is available to everyone who asks. When it automates a weekly report, the whole channel sees it.",
        ...
        "For teams that want one AI coworker doing real work — not four individual assistants drafting text — Gomer's shared workspace model is the better fit.",
      ],
    },
    {
      title: "3,200+ business integrations vs. workspace search.",
      paragraphs: [
        "Gomer connects to Stripe, HubSpot, Meta Ads, Google Ads, Notion, Linear, GitHub, and 3,200+ more with managed OAuth. One message can read revenue, update a CRM, and create a Linear issue.",
        ...
        "If your workflows require touching business tools — not just reading Slack messages — Gomer's integration depth is what you need.",
      ],
    },
  ],
  whenToChoose: {
    title: "When to choose Claude in Slack vs Gomer",
  ...
  testimonials: [
    {
      ...
      role: "CEO, Growably",
      quote:
        "Claude in Slack was great for drafting. Gomer is what we needed to actually run our weekly ops reports automatically.",
    },
    {
      name: "Sam Kopelman",
      role: "CEO, Givr",
      quote:
        "We had Claude helping us write. Gomer started doing — updating CRM, pulling metrics, shipping PDFs.",
    },
    {
      name: "Antonín Štětina",
      role: "CEO, KULINA Group",
      quote:
        "One Gomer workspace replaced the copy-paste loop between Claude drafts and our actual business tools.",
    },
  ],
  faqs: [
    {
      q: "Can I use both Claude in Slack and Gomer?",
      a: "Yes. Many teams use Claude for drafting and writing assistance, and Gomer for operational workflows that touch business tools. They complement each other.",
    },
    {
      q: "How is Claude Code different from Gomer?",
      a: "Claude Code (beta) routes coding tasks from Slack to claude.com/code for investigation and PRs. Gomer handles both coding and business operations — CRM, ads, reports, web apps — natively in Slack.",
    },
    {
      q: "Do I need separate Claude and Slack subscriptions for Gomer?",
      a: "No. Gomer is a standalone product. One workspace subscription covers your whole team.",
    },
    {
      q: "Is my data safe?",
