...
export const claudeInSlackCompareConfig: ComparePageConfig = {
  meta: {
    title: "Gaspo vs Claude in Slack — Coworker vs Assistant",
    description:
      "Compare Gaspo and Claude in Slack. Claude drafts and summarizes. Gaspo connects to 3,200+ tools and ships real work autonomously.",
    ogTitle: "Gaspo vs Claude in Slack — Coworker vs Assistant",
    ogDescription:
      "How Gaspo and Claude in Slack stack up on actions, integrations, deliverables, pricing, and team workflows.",
  },
  hero: {
    titleLine1: "Gaspo vs Claude in Slack:",
    titleLine2: "Coworker vs Assistant",
    subtitle:
      "Claude in Slack helps you draft and summarize. Gaspo connects to your tools, runs your reports, and delivers real outputs. One assists. The other executes.",
  ...
  rows: [
    ...
    },
    {
      ...
      gaspo: "Inside Slack and Microsoft Teams. @mention Gaspo like a colleague with full team access.",
      competitor:
  ...
  featureSections: [
    {
      title: "Gaspo executes. Claude assists.",
      paragraphs: [
        "Ask Gaspo to audit your ad spend and you get a polished PDF with live data from Meta Ads, Google Ads, and Stripe — delivered in your Slack thread in minutes. Gaspo pulled the data, ran the analysis, and formatted the report.",
        ...
        "Both use frontier AI models. The difference is authorization and connection. Gaspo is wired into your tools and empowered to act. Claude is wired into your conversations and empowered to advise.",
      ],
    },
    {
      title: "Shared team AI vs. individual assistant accounts.",
      paragraphs: [
        "Gaspo is one AI employee for your whole workspace. When it learns your Stripe billing patterns, that knowledge is available to everyone who asks. When it automates a weekly report, the whole channel sees it.",
        ...
        "For teams that want one AI coworker doing real work — not four individual assistants drafting text — Gaspo's shared workspace model is the better fit.",
      ],
    },
    {
      title: "3,200+ business integrations vs. workspace search.",
      paragraphs: [
        "Gaspo connects to Stripe, HubSpot, Meta Ads, Google Ads, Notion, Linear, GitHub, and 3,200+ more with managed OAuth. One message can read revenue, update a CRM, and create a Linear issue.",
        ...
        "If your workflows require touching business tools — not just reading Slack messages — Gaspo's integration depth is what you need.",
      ],
    },
  ],
  whenToChoose: {
    title: "When to choose Claude in Slack vs Gaspo",
  ...
  testimonials: [
    {
      ...
      role: "CEO, Growably",
      quote:
        "Claude in Slack was great for drafting. Gaspo is what we needed to actually run our weekly ops reports automatically.",
    },
    {
      name: "Sam Kopelman",
      role: "CEO, Givr",
      quote:
        "We had Claude helping us write. Gaspo started doing — updating CRM, pulling metrics, shipping PDFs.",
    },
    {
      name: "Antonín Štětina",
      role: "CEO, KULINA Group",
      quote:
        "One Gaspo workspace replaced the copy-paste loop between Claude drafts and our actual business tools.",
    },
  ],
  faqs: [
    {
      q: "Can I use both Claude in Slack and Gaspo?",
      a: "Yes. Many teams use Claude for drafting and writing assistance, and Gaspo for operational workflows that touch business tools. They complement each other.",
    },
    {
      q: "How is Claude Code different from Gaspo?",
      a: "Claude Code (beta) routes coding tasks from Slack to claude.com/code for investigation and PRs. Gaspo handles both coding and business operations — CRM, ads, reports, web apps — natively in Slack.",
    },
    {
      q: "Do I need separate Claude and Slack subscriptions for Gaspo?",
      a: "No. Gaspo is a standalone product. One workspace subscription covers your whole team.",
    },
    {
      q: "Is my data safe?",
